...
// GetItemsBySLId mocks base method.
func (m *MockDb) GetItemsBySLId(arg0 context.Context, arg1 string) ([]*model.Item, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetItemsBySLId", arg0, arg1)
	ret0, _ := ret[0].([]*model.Item)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetItemsBySLId indicates an expected call of GetItemsBySLId.
func (mr *MockDbMockRecorder) GetItemsBySLId(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetItemsBySLId", reflect.TypeOf((*MockDb)(nil).GetItemsBySLId), arg0, arg1)
}
